...
class CertificateSettings(db.Model):
    ...
    title_color = Column(String(7), default="#1a365d", nullable=False)
    ctf_title_color = Column(String(7), default="#B8860B", nullable=False)
    accent_color = Column(String(7), default="#B8860B", nullable=False)
